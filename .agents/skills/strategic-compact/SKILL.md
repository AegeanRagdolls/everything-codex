...
description: >-
  ...
  task phases rather than arbitrary auto-compaction. Use when Codex needs support for:
  Suggests manual context compaction at logical intervals to preserve context through
  task phases rather than arbitrary auto-compaction. Do not use for unrelated tasks.
