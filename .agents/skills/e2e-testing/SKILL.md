...
description: >-
  ...
  artifact management, and flaky test strategies. Use when Codex needs support for:
  Playwright E2E testing patterns, Page Object Model, configuration, CI/CD integration,
  artifact management, and flaky test strategies. Do not use for unrelated tasks. Inputs
