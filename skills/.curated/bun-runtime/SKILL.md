...
name: bun-runtime
description: >-
  Bun as runtime, package manager, bundler, and test runner. When to choose Bun vs Node,
  migration notes, and Vercel support. Use when Codex needs support for: Bun as runtime,
  package manager, bundler, and test runner. When to choose Bun vs Node, migration
  notes, and Vercel support. Do not use for unrelated tasks. Inputs should include
