...
description: >-
  ...
  Activates for setup questions, API references, code examples, or when the user names a
  framework (e.g. React, Next.js, Prisma). Do not use for unrelated tasks. Inputs should
