...
description: >-
  ...
  contained recovery, and introspection reports. Use when Codex needs support for:
  Structured self-debugging workflow for AI agent failures using capture, diagnosis,
  contained recovery, and introspection reports. Do not use for unrelated tasks. Inputs
