---
name: everything-codex-code-conventions
description: >-
  Development conventions and patterns for everything-claude-code. JavaScript project
  with conventional commits. Use when Codex needs support for: Development conventions
  and patterns for everything-claude-code. JavaScript project with conventional commits.
  Do not use for unrelated tasks. Inputs should include relevant files, constraints, and
  available tools. Output should be a concise plan, result, or verification summary.
---

# Everything Codex Code Conventions

> Generated from [affaan-m/everything-codex-code](https://github.com/affaan-m/everything-codex-code) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in everything-codex-code.
