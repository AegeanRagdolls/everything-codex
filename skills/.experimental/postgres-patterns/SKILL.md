...
description: >-
  ...
  security. Based on Supabase best practices. Use when Codex needs support for:
  PostgreSQL database patterns for query optimization, schema design, indexing, and
  security. Based on Supabase best practices. Do not use for unrelated tasks. Inputs
