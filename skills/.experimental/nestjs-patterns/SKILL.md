...
description: >-
  ...
  guards, interceptors, config, and production-grade TypeScript backends. Use when Codex
  needs support for: NestJS architecture patterns for modules, controllers, providers,
  DTO validation, guards, interceptors, config, and production-grade TypeScript
  backends. Do not use for unrelated tasks. Inputs should include relevant files,
