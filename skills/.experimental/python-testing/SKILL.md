...
description: >-
  ...
  parametrization, and coverage requirements. Use when Codex needs support for: Python
  testing strategies using pytest, TDD methodology, fixtures, mocking, parametrization,
  and coverage requirements. Do not use for unrelated tasks. Inputs should include
