...
description: >-
  ...
  efficient, and maintainable Python applications. Use when Codex needs support for:
  Pythonic idioms, PEP 8 standards, type hints, and best practices for building robust,
  efficient, and maintainable Python applications. Do not use for unrelated tasks.
