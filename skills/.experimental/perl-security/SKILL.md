...
name: perl-security
description: >-
  Comprehensive Perl security covering taint mode, input validation, safe process
  execution, DBI parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic
  security policies. Use when Codex needs support for: Comprehensive Perl security
  covering taint mode, input validation, safe process execution, DBI parameterized
  queries, web security (XSS/SQLi/CSRF), and perlcritic security policies. Do not use
  for unrelated tasks. Output should be a concise plan, result, or verification summary.
---
