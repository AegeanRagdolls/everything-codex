...
name: perl-patterns
description: >-
  Modern Perl 5.36+ idioms, best practices, and conventions for building robust,
  maintainable Perl applications. Use when Codex needs support for: Modern Perl 5.36+
  idioms, best practices, and conventions for building robust, maintainable Perl
  applications. Do not use for unrelated tasks. Inputs should include relevant files,
