...
description: >-
  ...
  are refactoring/performance tasks, not prompt optimization. Do not use for unrelated
  tasks. Inputs should include relevant files, constraints, and available tools.
---
