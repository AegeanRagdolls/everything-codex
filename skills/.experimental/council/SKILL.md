...
description: >-
  ...
  Use when multiple valid paths exist and you need structured disagreement before
  choosing. Do not use for unrelated tasks. Inputs should include relevant files,
