...
description: >-
  ...
  property-based testing, mocking, and coverage. Follows TDD methodology. Use when Codex
  needs support for: Rust testing patterns including unit tests, integration tests,
  async testing, property-based testing, mocking, and coverage. Follows TDD methodology.
