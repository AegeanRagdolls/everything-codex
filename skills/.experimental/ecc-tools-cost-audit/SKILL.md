...
description: >-
  Evidence-first ECC Tools burn and billing audit workflow. Use when investigating
  runaway PR creation, quota bypass, premium-model leakage, duplicate jobs, or GitHub
  App cost spikes in the ECC Tools repo. Do not use for unrelated tasks. Inputs should
...
- work in the sibling `ECC-Tools` repo, not in `everything-codex-code`
