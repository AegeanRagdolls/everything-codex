...
name: laravel-tdd
description: >-
  Test-driven development for Laravel with PHPUnit and Pest, factories, database
  testing, fakes, and coverage targets. Use when Codex needs support for: Test-driven
  development for Laravel with PHPUnit and Pest, factories, database testing, fakes, and
  coverage targets. Do not use for unrelated tasks. Inputs should include relevant
