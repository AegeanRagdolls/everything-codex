...
name: perl-testing
description: >-
  Perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage
  with Devel::Cover, and TDD methodology. Use when Codex needs support for: Perl testing
  patterns using Test2::V0, Test::More, prove runner, mocking, coverage with
  Devel::Cover, and TDD methodology. Do not use for unrelated tasks. Inputs should
