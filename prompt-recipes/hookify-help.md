# Hookify Help Prompt Recipe

## Codex invocation

Ask Codex to execute the `hookify-help` workflow as a normal prompt. Provide the target files, repository context, constraints, and whether edits are allowed.
...
This is a Codex prompt recipe, not a Claude slash command. In Codex, paste this file's body into the chat or ask: "Use the `hookify-help` prompt recipe for <task>."

**Original command intent:** Get help with the hookify system. Use when Codex needs support for: Get help with the hookify system.
